...
import { createError, handleError, ErrorCategory, ErrorSeverity } from './error-handling.js';
...
export async function handleApiError(
  ...
  try {
    ...
    if (err instanceof Response) {
      await handleFetchResponseError(err, componentName, showToast);
    }
